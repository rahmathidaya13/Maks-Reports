            ...
            <div class="py-4">
                <div class="p-4 bg-light mb-3 rounded-4 border shadow">
                    <div
                        ...
                        <div>
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-0 text-dark">Dashboard Performa Penjualan</h5>
                                    <p class="text-muted small mb-0">
                                        <i class="bi bi-calendar3 me-1"></i> Periode:
                                        <span class="fw-semibold text-primary">{{ stats.current_month_name }}</span>
                                    </p>
                                </div>
                            </div>
                        </div>

                        <div class="d-flex gap-2 bg-white p-2 rounded-3 shadow-sm border text-dark align-items-center">
                    ...
                    <div class="position-relative">
                        ...
                        <div class="row g-4" :class="['dashboard-content', isLoading ? 'is-loading' : '']">
                                ...
                                <div class="card border shadow-sm overflow-hidden rounded-4 h-100">
                                    <div class="card-body p-4 position-relative text-bg-white">
                                        ...
                                        <div class="d-flex align-items-center ">
                                            ...
                                            <div>
                                                <h6 class="text-muted small fw-bold text-uppercase mb-1">Estimasi
                                                    Bonus</h6>
                                ...
                                <div class="card border shadow-sm rounded-4 h-100 overflow-hidden">
                                    <div
                                        ...
                                        <h5 class="m-0 fw-bold text-dark">
                                            <i class="bi bi-bar-chart-line me-2 text-primary"></i>Statistik Penjualan
                                            Harian
                                        </h5>
                                    </div>
                                    <div class="card-body px-4 pb-4">
                                        <div class="chart-wrapper">
                                            <chart-bar type="bar" :height="300" :labels="props.chart_data.labels"
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="mt-3 pt-3 border-top">
                                            <div class="d-flex align-items-center justify-content-between small">
                                                ...
                                                <span :class="stats.growth >= 0 ? 'text-success' : 'text-danger'"
                                                    class="fw-bold">
                                                    <i
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover align-middle mb-0">
                                                <thead class="bg-light border-0">
                                                    <tr>
                                                        <th class="ps-4 py-3 text-muted fw-bold small text-uppercase">
                                                            Produk
                                                        </th>
                                                        <th
